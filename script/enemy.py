...
class Enemy:
    ...
    def __init__(self, pos, level, hp, damage, ani_sprite, sec_cooldown=5):
...
class Zombie(Enemy):
    ...
    def __init__(self, pos, level, ani_sprite, sec_cooldown=5):
        ...
        super().__init__(pos, level, hp, damage, ani_sprite, sec_cooldown)
